...
class Ui_RS232transmitter(object):
    def setupUi(self, RS232transmitter):
        ...
        self.inputTextCoded.viewport().setProperty("cursor", QCursor(Qt.ForbiddenCursor))
        ...
        self.receivedTextDecoded.viewport().setProperty("cursor", QCursor(Qt.ForbiddenCursor))
        ...
        self.reveivedTextCoded.viewport().setProperty("cursor", QCursor(Qt.ForbiddenCursor))
